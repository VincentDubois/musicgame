...
public class SpriteSheet {
	...
	private SpriteSheet(int n, int m){
		this.n = n;
		this.m = m;
	...
	private SpriteSheet(Context context, int id, int n, int m){
		this(n,m);
		load(context,id);
    ...
    public static void register(Context context, int id, int columns, int lines){
        map.put(id,new SpriteSheet(context,id,columns,lines));
    }
